...
Motivated by this view, my research aims to advance flexible modeling approaches for complex data in psychology and, more broadly, in the social and behavioral sciences. As detailed in the [Program of Research](#program-of-research), I specialize in Bayesian methods, missing data techniques, and latent variable modeling.

A complete list of my refereed journal publications related to these research areas can be found on the [Articles](articles.qmd) page. For additional details on my academic training and experience, please see my [curriculum vitae](Ihnwhi Heo CV Current.pdf).
